...
import com.zenika.systemmanager.test.service.TestService;
...
@Instantiate
@Provides
public class TestServiceImpl implements TestService, GraniteDestination {
    ...
    @Override
    public String setObject(List<TestClass> classes) {
        String ret = "";
    ...
    @Override
    public String getId() {
        return "com.zenika.systemmanager.test.service.TestService";
    }
